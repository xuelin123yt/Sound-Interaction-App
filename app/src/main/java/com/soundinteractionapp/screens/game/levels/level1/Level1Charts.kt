...
/**
 * 音符資料結構
 * 如果您的專案中已經在其他地方定義了 Note，可以註解掉這一行，
 * 但建議保留在此處以確保 Level 1 的獨立性。
 */
...
object Level1Charts {
    ...
    /**
     * 自動計算滿分工具
     * @param totalNotes 總音符數
     * @param rushThreshold 進入 Rush Time 的 Combo 門檻
     */
    fun calculateMaxScore(totalNotes: Int, rushThreshold: Int): Int {
        if (totalNotes <= rushThreshold) {
            return totalNotes * 100
        }
        // 前段 (未進入 Rush) 分數：每個 100 分
        val basePart = rushThreshold * 100
        // 後段 (Rush Time) 分數：每個 150 分
    ...
    // ============================================================================================
    // 1. 給愛麗絲 (Fur Elise)
    // 變數名稱：LEVEL1_EASY_CHART (對應 Difficulty.NORMAL)
    // 音符數：166
    // ============================================================================================
    ...
    // ============================================================================================
    // 2. 卡農 (Canon)
    // 變數名稱：LEVEL1_NORMAL_CHART (對應 Difficulty.EASY)
    // 音符數：96
    // ============================================================================================
    ...
    // ============================================================================================
    // 3. 土耳其進行曲 (Rondo Alla Turca)
    // 變數名稱：LEVEL1_HARD_CHART (對應 Difficulty.HARD)
    // 音符數：239
    // ============================================================================================
